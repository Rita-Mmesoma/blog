...
const Navbar = () => {
  ...
  return (
    <div className='flex flex-row justify-center md:justify-between items-center bg-black/90 text-gray-400 px-3 h-[10vh] w-full top-0 z-50 sticky'>

      {/* <div className='flex md:hidden'>
        <RxHamburgerMenu onClick={showMenu} className='hover:cursor-pointer text-[22px]' />
        ${openMenu ? ' w-[100%] bg-pink-400  h-[100vh]' : 'hidden'} 
      </div> */}

      <ul className={` flex flex-row gap-2 items-center justify-center h-full `}>
